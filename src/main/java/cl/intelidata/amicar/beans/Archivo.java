...
public class Archivo {
	...
	public void guardarLista(List<String> lista, String strRuta, String strCabecera, String strExtension) {
		...
		try {
			...
			bufferedWriterArchivo = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(strRuta + "Generado.txt"), "UTF-8"));
	...
	public void guardarListaCSV(List<String> lista, String strNombreArchivo, String strCabecera) {
		...
		try {
			bufferedWriter = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(strArchivo), "UTF-8"));
			System.out.println("Creando el archivo " + strArchivo);
			if (strCabecera != null) {
				// Inserta la cabecera del archivo
				System.out.println("Insertando Cabecera...");
